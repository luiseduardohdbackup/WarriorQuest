...
local ActivateGameScene = class("ActivateGameScene",function()
    return cc.Scene:create()
end)

function ActivateGameScene.create()
    local scene = ActivateGameScene.new()
...
function ActivateGameScene:ctor()
    self.visibleSize = cc.Director:getInstance():getVisibleSize()
    self.origin = cc.Director:getInstance():getVisibleOrigin()
    self.schedulerID = nil
end

function ActivateGameScene:playBgMusic()
...
function ActivateGameScene:creatDog()
...
-- create farm
function ActivateGameScene:createLayerFarm()
...
-- create menu
function ActivateGameScene:createLayerMenu()
